# AUTOGENERATED! DO NOT EDIT! File to edit: notebooks/notebooks/02_interpolate_target.ipynb (unless otherwise specified).
...
# Cell
def make_grid(box_size, resolution):
    xmin, ymin = 0, 0
    xmax, ymax = box_size
...
# Cell
def interpolate(data_nodal, box_size, resolution, verbose=False):
    grid_x, grid_y, grid_flat = make_grid(box_size, resolution)
