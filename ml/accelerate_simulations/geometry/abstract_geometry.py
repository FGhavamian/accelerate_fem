...
class AbstractGeometry:
    def __init__(self, circle_density, circle_radius_range, box_size, gap, seed, stop_tol=10):
    ...
    def _compute_n_circles(self, circle_density):
        ...
        n_circles = int(effective_box_area/avg_circle_area)
        return n_circles
    ...
    def _generate_random_circles(self):
        ...
        while counter < self.n_circles:
            ...
            attempts += 1
            if attempts > self.stop_tol * self.n_circles:
                # print(f'''[WARNING] {attempts} attempts, returning {len(circles)}/{self.n_circles} circles''')
                return circles
