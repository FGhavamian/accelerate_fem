...
class GeometricFieldMaker:
    def __init__(self, geometry_rasterizer: GeometryRasterizer, names_boundary):
    ...
    def _dist_radial(self, x, scaling_factor=5):
        return np.exp(-scaling_factor * x/(x.max()+1e-8))
